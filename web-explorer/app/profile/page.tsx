...
export const metadata: Metadata = {
  title: "Profile | SolanaPilot Registry",
  description: "View and manage your SolanaPilot developer profile and program statistics.",
};
        ...
        >
          <div className="flex flex-col items-center justify-center py-12 sm:py-16 px-4 text-center">
            <div 
              ...
              aria-hidden="true"
            >
              <User className="size-8 sm:size-10 text-secondary/60" />
            </div>
            <h1 className="text-xl sm:text-2xl font-bold text-foreground mb-2">
              Developer Profile
            </h1>
            <p className="text-muted-foreground text-xs sm:text-sm max-w-sm mb-4 sm:mb-6">
              Connect your wallet to view your developer profile and program statistics.
            </p>
